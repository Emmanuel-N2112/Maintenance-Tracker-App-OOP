    ...
    function display_userview_content() {
        ...
        echo '
            <div class="body-content text-justify">
                ...
                <p class="content text-justify">Maintenance tracker app users can either be customers, company staff or company.</p>
                <p class="content text-justify">Currently, you are a Customer. A customer begins by entering devices he or she would like Maintenance and Repairs companies to monitor. Then can the customer make requests to companies currently using this online system and wait for response.</p>
                <p class="content text-justify">In order for a user to change status, a user can click Leaderboard on the top horizontal navigation bar where he or she will fill special information to either register as staff or an administrator.</p>
            </div>
        </div>
            ';
    }
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form3" method="post" action=" ">
                                                <input type="hidden" name="id" value="'.$row_id.'">
                                                <input type="text" name="orderTitle" value="'.$row["OrderTitle"].'" placeholder="Title...">
                                                <input type="text" name="description" value="'.$row["OrderDesc"].'" placeholder="Description...">
